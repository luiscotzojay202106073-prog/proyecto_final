...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="<?=base_url('unidades1')?>">PRIMERA UNIDAD</a>
                    </li>
                    <li class="nav-item">
    ...
    <table class="table table-striped-columns">
        ...
        <tbody>
            ...
            ?>
            <tr>
                <td> <?=$unidad['carne_alumno'];?> </td>
                <td> <?=$unidad['curso_1'];?> </td>
                <td> <?=$unidad['curso_2'];?> </td>
