        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?=base_url('unidades2')?>">SEGUNDA UNIDAD</a>
                    </li>
                    <li class="nav-item">
    ...
    <table class="table table-striped-columns">
        ...
        <tbody>
            <?php
                ...
                foreach ($datos as $unidad2) {
                    
                
            ?>
            <tr>
                <td> <?=$unidad2['carne_alumno'];?> </td>
                <td> <?=$unidad2['curso_1'];?> </td>
                <td> <?=$unidad2['curso_2'];?> </td>
                ...
                <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
                 <a href="<?=base_url('buscar_unidad2/').$unidad2['carne_alumno'];?>" class="btn btn-outline-primary bg-gradient text-primary shadow px-4"><i class="bi bi-pencil-square fs-4"></i></a>
                    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
                </td>
            </tr>
            <?php
