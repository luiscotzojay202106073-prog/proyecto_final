        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?=base_url('tiposusuarios')?>">TIPOS DE USUARIOS</a>
                    </li>
                    <li class="nav-item">
    ...
    <table class="table table-striped-columns">
        ...
        <tbody>
            <?php
                ...
                foreach ($datos as $tiposusuario) {
                    
                
            ?>
            <tr>
                <td> <?=$tiposusuario['tipo_usuario_id'];?> </td>
                <td> <?=$tiposusuario['nombre'];?> </td>
