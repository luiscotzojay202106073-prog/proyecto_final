...
<head>
    ...
    <title>MODIFICAR UNIDAD 2</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0"><i class="bi bi-person-badge"></i>Modificar Datos de la unidad 2</h5>
        </div>
        <div class="card-body">
            <form action="<?=base_url('modificar_unidad2');?>" method="post">
                <div class="mb-2">
