...
<head>
    ...
    <title>MODIFICAR UNIDAD 3</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0"><i class="bi bi-person-badge"></i>Modificar Datos de la unidad 3</h5>
        </div>
        <div class="card-body">
            <form action="<?=base_url('modificar_unidad3');?>" method="post">
                <div class="mb-2">
                ...
                <div class="row g-2">
                    <div class="col-md-6">
                        ...
                        <input type="num" class="form-control" name="txt_curso1" id="txt_curso1" required value="<?php echo $datos['curso_1'];?>">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="row g-2 mt-1">
                    <div class="col-md-6">
                        <label for="txt_curso5" class="form-label">Sistema e instalación</label>
