        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?=base_url('unidades3')?>">TERCERA UNIDAD</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?=base_url('unidades4')?>">CUARTA UNIDAD</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?=base_url('agregar_unidad3');?>" method="post">
                                <div class="mb-2">
    ...
    <table class="table table-striped-columns">
        ...
        <tbody>
            <?php
                ...
                foreach ($datos as $unidad3) {
                    
                
            ?>
            <tr>
                <td> <?=$unidad3['carne_alumno'];?> </td>
                <td> <?=$unidad3['curso_1'];?> </td>
                <td> <?=$unidad3['curso_2'];?> </td>
                <td> <?=$unidad3['curso_3'];?> </td>
                <td> <?=$unidad3['curso_4'];?> </td>
                <td> <?=$unidad3['curso_5'];?> </td>
                <td>
                    <a href="<?=base_url('eliminar_unidad3/').$unidad3['carne_alumno'];?>" class="btn btn-outline-danger bg-gradient text-danger shadow px-4"><i class="bi bi-trash-fill fs-4"></i></a>
                    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
                    <a href="<?=base_url('buscar_unidad3/').$unidad3['carne_alumno'];?>" class="btn btn-outline-primary bg-gradient text-primary shadow px-4"><i class="bi bi-pencil-square fs-4"></i></a>
                    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.css" rel="stylesheet">
                </td>
            </tr>
            <?php
