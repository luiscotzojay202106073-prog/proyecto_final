...
<body>
    ...
    <div class="row">
        ...
        <section class="text-center mb-5">
            ...
            <p class="fs-5"><u>Luis Antonio Cotzojay Culajay 202106073</u> <br> "Diseño, estructura y configuración
                completa de la página, visualización de todas las bases de datos, login, CRUD estudiantes y usuarios"
            </p>
            <br>
            <p class="fs-5"><u>Gabriela Magaly de León Secay 202106372</u> <br> "Funciones de agregar, eliminar y
                modificar notas de la primera y segunda unidad" </p>
            <br>
            <p class="fs-5"><u>Miriam Elizabeth Mejía Ajanel 202105950</u> <br> "Funciones de agregar, eliminar y
                modificar notas de la tercera y cuarta unidad"</p>
